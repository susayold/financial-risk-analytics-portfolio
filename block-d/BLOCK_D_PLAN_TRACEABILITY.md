...
| D9 Closure | Assemble closure manifest, reconcile gates and record owner sign-off | `D9_CLOSURE/`; `D9_APPROVAL_REGISTER.md`; `D9_APPROVAL_REGISTER.json`; `D9_APPROVAL_VALIDATION.json`; `D9_DECISION_GAP_REGISTER.md`; `BLOCK_D_APPROVAL_DECISION_PACK.md`; `BLOCK_D_VALIDATION_REPORT.md`; `D5_D9_DOWNSTREAM_GATE_REGISTER.md`; `D5_D9_GATE_QA.json` | CONTROLLED_HOLD; `NOT_LOCKED_REVIEW_REQUIRED`; downstream QA 5/5 | D4–D8 approvals plus data/model/risk owner sign-off, then rerun D9 |
